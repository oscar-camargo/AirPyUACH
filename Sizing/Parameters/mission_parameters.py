...
class ground():    
    ...
    @staticmethod
    def _conditions():
        return [getattr(ground,method)()['Condition'] for method in dir(ground)[27:]]
    @staticmethod
    def ground():
...
class climb():
    @staticmethod
    def _conditions():
        return [getattr(climb,method)()['Condition'] for method in dir(climb)[27:]]
    @staticmethod
...
class cruise():
    @staticmethod
    def _conditions():
        return [getattr(cruise,method)()['Condition'] for method in dir(cruise)[27:]]
    @staticmethod
...
class descent():
    ...
    @staticmethod
    def _conditions():
        return [getattr(descent,method)()['Condition'] for method in dir(descent)[27:]]
    @staticmethod
    def constant_cas_constant_rate():
...
class hover():
    ...
    @staticmethod
    def _conditions():
        return [getattr(hover,method)()['Condition'] for method in dir(hover)[27:]]

class single_point():
    @staticmethod
    def _conditions():
        return [getattr(single_point,method)()['Condition'] for method in dir(single_point)[27:]]
    @staticmethod
...
class transition():
    @staticmethod
    def _conditions():
        return [getattr(transition,method)()['Condition'] for method in dir(transition)[27:]]
    @staticmethod
...
#test = transition()
#testdict = test.constant_acc_constant_angle_linear_climb()
#testdict['Initial Altitude'] = 1000
#testdict.popitem()
#print(testdict)
#test.constant_cas_constant_rate().popitem()
